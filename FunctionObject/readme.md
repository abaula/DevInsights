...
Паттерн Function Object — широко известный и мощный инструмент построения гибких систем, позволяющий целиком вынести логику каждого метода в отдельный класс.

В статье показано как совмещение Function Object с Dependency Injection (DI) даёт дополнительные преимущества в архитектуре приложений.
