...
Если важно обозначить, обратить внимание, что речь идёт о сложной структуре и алгоритмах обработки временных данных, то нужно использовать термин "шаблон Буфер", "Buffer pattern" или "Buffer design pattern", а не "буферизация".
