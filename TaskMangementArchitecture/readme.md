...
Подсистема не проектировалась для максимальной производительности, фокусом было - обеспечить надёжное обновление данных строго в интервалах времени указанных каждым источником данных. Узким местом для подсистемы всегда является сам источник данных, скорость работы которого в разы меньше скорости работы остальных компонентов подсистемы.
